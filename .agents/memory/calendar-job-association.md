...
- La descrizione Google contiene un blocco dati lavoro con marker emoji (`📋 Lavoro:`, `👤 Cliente:`, `📅 Data evento:`, `🔗 Apri scheda lavoro:`): quando si (s)collega, prima strippare le righe con quei marker e poi (se collegato) riappendere il blocco ricostruito — mai appendere senza strip o si duplicano i blocchi.
