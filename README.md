...
Il mockup cliente si sblocca **dopo l’approvazione delle pagine correnti**. Sul telefono si sfogliano prima i modelli, poi gli esempi compatibili; solo dopo parte il 3D. In orizzontale il pannello opzioni ha più spazio, con anteprima espandibile, icone compatte e **In casa** sempre raggiungibile. Foto solo dalla galleria del servizio. Il girevole v4 mantiene la stampa sul plexiglass dello scrigno durante l’estrazione del libro; i salvataggi precedenti restano conservati. L’admin usa le schede **Verifica / Modifica / Modelli disponibili**, con anteprima ferma e comandi separati. Ogni nuova revisione inviata dal cliente notifica lo studio via email; salvare una bozza non invia email. Dettagli e verifiche in [Mockup album](docs/MOCKUP-ALBUM.md#percorso-cliente-guidato-mobile-first).
