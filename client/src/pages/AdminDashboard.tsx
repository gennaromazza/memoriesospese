...
import { AdminGalleriesSection } from "@/components/admin/galleries/AdminGalleriesSection";
import {
  Collapsible,
  CollapsibleContent,
  CollapsibleTrigger,
          ...
          >
            ...
            <TabsContent value="galleries">
              <AdminGalleriesSection
                galleries={galleries}
                currentGalleries={galleryPagination.currentItems}
                isLoading={isLoading}
                expanded={galleriesExpanded}
                onExpandedChange={setGalleriesExpanded}
                referrerGallery={referrerGallery}
                onClearReferrer={() => {
                  sessionStorage.removeItem("adminReferrerGallery");
                  setReferrerGallery(null);
                }}
                ...
                onGalleryTypeFilterChange={setGalleryTypeFilter}
                selectionFilter={selectionFilter}
                onSelectionFilterChange={setSelectionFilter}
                galleryJobTypeFilter={galleryJobTypeFilter}
                onGalleryJobTypeFilterChange={setGalleryJobTypeFilter}
                jobTypes={dashboardJobTypes}
                ...
                onPreviousPage={galleryPagination.goToPreviousPage}
                onNextPage={galleryPagination.goToNextPage}
                canManageGalleries={isCurrentUserAdmin()}
                onOpenCreate={openModal}
                onToggleStatus={toggleGalleryStatus}
