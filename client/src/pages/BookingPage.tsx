...
export default function BookingPage() {
  ...
  useSEO({
    title: campaign ? `${campaign.nome} - Prenota il tuo shooting` : 'Prenota | Image Studio',
    description: campaign?.descrizione || 'Prenota il tuo servizio fotografico con Image Studio.',
    canonical: `/prenota/${code}`,
    ogImage: campaign?.immaginePaginaBooking,
    ogImageAlt: campaign ? `Prenotazione ${campaign.nome}` : undefined,
    ogImageSource: 'editorial-cover',
    noindex: !isLoading && !campaign,
  });
  ...
  if (campaign) {
    ...
    let currentDate =
      today < startOfDay(campaign.dataInizio)
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (isBefore(slotDate, now)) {
      toast({
        ...
        description:
          "Lo slot selezionato è ormai passato. Seleziona un altro orario.",
        variant: "destructive",
      });
        ...
        <Card className="max-w-md w-full">
          ...
          <CardContent className="space-y-4">
            <p className="text-muted-foreground">
              La campagna con codice <strong>{code}</strong> non è stata trovata
              o non è più attiva.
            </p>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-sage-50 to-cream-50 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center px-4">
        <Card className="max-w-md w-full">
          ...
          <CardContent className="space-y-4">
            <p className="text-muted-foreground">
              La campagna <strong>{campaign.nome}</strong> non è attualmente
          ...
          <CardContent className="space-y-4">
            ...
            <div className="bg-muted rounded-lg p-4 space-y-2">
              <p className="text-sm">
                <strong>Data:</strong>{" "}
                {selectedSlot &&
                  format(new Date(selectedSlot.start), "dd MMMM yyyy", {
                    locale: it,
                  })}
              </p>
              <p className="text-sm">
                <strong>Orario:</strong> {selectedSlot?.startTime} -{" "}
            ...
            <p className="text-sm text-muted-foreground">
              Riceverai una email di conferma all'indirizzo fornito. Lo staff ti
              contatterà a breve per confermare la prenotazione.
            </p>
            <Button onClick={() => setLocation("/")} className="w-full">
              Torna alla homepage
            </Button>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sage-50 to-cream-50 dark:from-gray-900 dark:to-gray-800 py-12 px-4">
      <div className="max-w-4xl mx-auto space-y-8">
        {/* Hero Image (solo immagine, senza testo) */}
        {campaign.immaginePaginaBooking && (
          <div className="relative w-full h-64 md:h-96 rounded-xl overflow-hidden shadow-xl mb-6 md:mb-8">
            <img
        ...
        <Card className="shadow-md border border-gray-100">
          <CardContent className="space-y-6 md:space-y-8 pt-8">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-amber-800 dark:text-amber-200">
                    ...
                    <strong>
                      {format(campaign.dataInizio, "dd MMMM yyyy", {
                        locale: it,
                      })}
                    </strong>
                    . Torna a visitare questa pagina quando le prenotazioni
                    saranno attive!
                  </p>
                </div>
              </div>
                ...
                {availableDates.length === 0 ? (
                  <div className="text-center py-8 text-muted-foreground">
                    ...
                    <p className="text-sm mt-2">
                      La campagna {campaign.nome} è terminata o non ha date
                      disponibili.
                    </p>
                  </div>
                ) : (
                ...
                <CardContent>
                  {loadingSlots ? (
                    ...
                    <div className="text-center py-8 text-muted-foreground">
                      ...
                      <p className="text-sm mt-2">
                        Prova a selezionare un'altra giornata
                      </p>
                    </div>
                  ) : (
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                          ...
                          <Card
                            ...
                            onClick={() =>
                              setFormData({ ...formData, prodottoId: "" })
                            }
                                ...
                                product.immagini.length > 0 ? (
                                  <div className="relative w-full h-48 sm:h-52 bg-muted overflow-hidden rounded-t-lg group">
                                    <img
                                      src={
                                        product.immagini[
                                          getProductImageIndex(product.id)
                                        ]
                                      }
                                  ...
                                  {product.descrizione && (
                                    <div className="space-y-1">
                                      ...
                                      <button
                                        type="button"
                                        onClick={(e) =>
                                          toggleDescription(product.id, e)
                                        }
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <div className="bg-muted rounded-lg p-4 space-y-2">
                      ...
                      <p className="text-sm">
                        ⏱️ Durata: {campaign.durataShootingMinuti} minuti
                      </p>
                    </div>
                    ...
                    <p className="text-xs text-center text-muted-foreground">
                      Cliccando conferma, riceverai una email con i dettagli
                      della prenotazione. Lo staff ti contatterà per la conferma
                      definitiva.
                    </p>
                  </CardContent>
                </Card>
