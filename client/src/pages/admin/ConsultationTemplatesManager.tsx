...
export default function ConsultationTemplatesManager() {
  ...
  const handleSave = async () => {
    try {
      ...
      if (editingTemplate) {
        ...
        await createMutation.mutateAsync(formData as InsertConsultationTemplate);
        toast({
      ...
      const errorMessage = error instanceof Error ? error.message : 'Operazione fallita';
      toast({
        variant: 'destructive',
        title: 'Errore',
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : 'Eliminazione fallita';
      toast({
        variant: 'destructive',
        title: 'Errore',
        description: errorMessage
  ...
  const updateJobDataField = (index: number, updates: Partial<ConsultationJobField>) => {
    setFormData(prev => ({
      ...prev,
      jobDataFields: prev.jobDataFields?.map((field, i) =>
        i === index ? { ...field, ...updates } as ConsultationJobField : field
      )
    }));
  };
  ...
  const sortedTemplates = [...templates].sort((a: ConsultationTemplate, b: ConsultationTemplate) => {
  ...
  return (
    <div className="container mx-auto py-8 px-4">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Template Consulenze</h1>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {templates.filter(t => t.attiva).length} template attivi su {templates.length} totali
          </CardDescription>
        </CardHeader>
        <CardContent>
          {isLoading ? (
                    ...
                    >
                      ...
                      <TableCell>
                        <Badge variant="outline">
                          {jobTypes.find((jt: JobTypeDoc) => jt.slug === template.jobType)?.nome || template.jobType}
                        </Badge>
                      </TableCell>
                      <TableCell>
                        ...
                        <TableCell colSpan={7} className="py-4">
                          <div className="pl-8 space-y-2">
                            <p className="text-sm text-gray-700">
                              <strong>Descrizione:</strong> {template.descrizione}
                            </p>
                            {template.jobDataFields && template.jobDataFields.length > 0 && (
                              <div>
                                ...
                                <div className="space-y-1">
                                  {template.jobDataFields.map((field: ConsultationJobField, idx: number) => (
                                    <div
                                      key={idx}
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => setFormData(prev => ({ ...prev, durataMinuti: parseInt(e.target.value) }))}
                    ...
                    <Card key={idx} className="p-4">
                      <div className="grid grid-cols-2 gap-3">
                        <div className="space-y-2">
                          ...
                          <Input
                            value={field.label}
                            onChange={(e) => updateJobDataField(idx, { label: e.target.value })}
                        ...
                        <div className="space-y-2">
                          ...
                          <Select
                            value={field.type}
                            onValueChange={(value) => updateJobDataField(idx, { type: value as any })}
                          >
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            onChange={(e) => updateJobDataField(idx, { placeholder: e.target.value })}
                        ...
                        <div className="flex items-end gap-4">
                          <div className="flex items-center gap-2">
                            <Switch
                              ...
                              onCheckedChange={(checked) => updateJobDataField(idx, { required: checked })}
      ...
      <AlertDialog open={!!deleteConfirmId} onOpenChange={() => setDeleteConfirmId(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Sei sicuro di voler eliminare questo template? Questa azione è irreversibile.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
