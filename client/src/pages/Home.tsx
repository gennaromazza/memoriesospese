    ...
    <div className="min-h-screen">
      ...
      <section id="access-gallery" className="py-20 bg-off-white relative">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 animate-fade-in relative z-10">
          ...
          {/* Feature Cards Aggiuntive - spostate dalla sezione About */}
          <div className="mt-16">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center mb-12">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-6 py-3 bg-sage hover:bg-dark-sage text-white font-medium rounded-lg shadow-md transition-all hover:shadow-lg hover:scale-105 duration-300"
              >
                <InstagramIcon className="w-5 h-5" />
                <span>@{studioSettings.socialLinks.instagram
                  .replace(/^https?:\/\/(www\.)?instagram\.com\//, '')
                  .replace(/^@/, '')
                  .replace(/\/$/, '')
                  .replace(/[?#].*$/, '')}</span>
            ...
            <div className="bg-white rounded-xl shadow-lg border border-beige p-4 sm:p-8 overflow-hidden">
