...
- **Email System:** Gmail API integration via Replit OAuth2 connector for email notifications. Firebase Cloud Functions handle all email operations (new photos, welcome emails, gallery passwords). Zero-configuration setup with automatic token management and robust error handling.
