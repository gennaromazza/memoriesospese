...
export const PRINT_SHOP_LEGAL_MANIFEST = Object.freeze({
  schemaVersion: 'print-shop-legal-2026-08-31.2',
  termsVersion: '2026-08-31.2',
  privacyVersion: '2026-08-31.2',
  personalizedProductionVersion: '2026-08-31',
  paymentPolicy: 'paypal_advance_only',
  fulfillmentMethods: ['studio_pickup', 'shipping'] as const,
  shippingRequiresBillingDetails: true,
