...
/** Choose the first usable WhatsApp number from the fields used by client records. */
export function getClientWhatsAppPhone(client: {
  whatsapp?: unknown;
  cellulare1?: unknown;
  cellulare2?: unknown;
  telefono?: unknown;
  ...
  for (const value of [client.whatsapp, client.cellulare1, client.cellulare2, client.telefono, client.cellulare]) {
